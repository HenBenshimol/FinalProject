...
namespace FinalProject.Data.Migrations
{
    ...
    [Migration("20180807093141_UpdateEnterCommentArticleTable")]
    partial class UpdateEnterCommentArticleTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinalProject.Models.Enter", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("FinalProject.Models.Comment", b =>
                {
                    b.HasOne("FinalProject.Models.Article", "ArticleComment")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("FinalProject.Models.Enter", b =>
                {
                    b.HasOne("FinalProject.Models.Article", "EnterArticle")
                        .WithMany()
                        .HasForeignKey("ArticleId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("FinalProject.Models.ApplicationUser", "EnterUser")
                        .WithMany()
